...
#Similar function, not used. Retained as comment for reference: ActIntervalMean <- aggregate(x=list(MeanSteps=activitydata$steps), by=list(interval=activitydata$interval), FUN=mean, na.rm=T)
